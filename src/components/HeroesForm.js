...
export default function HeroesForm({heroes, setHeroes}) {
    ...
    function handleAddHero(e){
       ...
       setHeroes(prevHeroes => {
            return [...prevHeroes, {id: uuidv4(), name: name, strength: strength, complete: false}]
        })
    ...
    return (                  
        <div>
            <Row className=" "  >                            
                <Col style={{ justifyContent:'center' }} className="HeroColumn counterColumn block-example ">
                    <h1 className="heroesMainTitle">Add Your Hero</h1>

                    <div className="form-floating mb-3">
                        <input type="text" className="form-control" id="floatingInput" placeholder="Enter Hero Name" ref={heroNameRef} />
                    ...
                    <div className="form-floating mb-3">
                        ...
                        defaultValue="500"
                        ref={heroStrengthRef} />
                        <label htmlFor="floatingInput">Hero Power Level (enter a number)</label>
                    </div>
                    <div className= "centerdButton">
                        <Button type="submit" className= "mb-3" onClick={handleAddHero}>Add Hero</Button>{' '}
                    </div>
                </Col>
