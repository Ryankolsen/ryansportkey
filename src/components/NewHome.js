...
function NewHome() {
  ...
  return (
    <div>
      ...
      >
        <Carousel style={{ justifyContent: "center" }}>
          <Carousel.Item interval={3500} style={{ justifyContent: "center" }}>
            <Card
              bg={"dark"}
              style={{ maxWidth: "50rem", justifyContent: "center" }}
            >
              <Card.Img variant="top" src={projImg1} className="mt-3" />
              <Card.Body>
                <Card.Title className="projectCard">
                  Flask Blog Website
                </Card.Title>
                <Card.Text className="projectCardText">
                  This full-featured Django application was built from scratch
              ...
              <Card.Footer>
                <Button
                  ...
                  href="https://www.ryanswebsite0909.com/"
                >
                  See the Site
                </Button>
                <Button
                  variant="primary"
                  href="https://github.com/Ryankolsen/DjangoWebsite"
                >
                  See the code
                </Button>
              </Card.Footer>
          ...
          <Carousel.Item interval={3500} style={{ justifyContent: "center" }}>
            ...
            >
              ...
              <Card.Body>
                ...
                <Card.Text className="projectCardText">
                  Windows Forms Application using C# and SQL Server. Created on
              ...
              <Card.Footer>
                <Button
                  className="twoButtons"
                  variant="primary"
                  href="https://github.com/Ryankolsen/SQL_DB_VS_/blob/main/DB_VS_EX.mp4"
                >
                  Video
                </Button>
                <Button
                  variant="primary"
                  href="https://github.com/Ryankolsen/SQL_DB_VS_"
                >
                  See the code
                </Button>
              </Card.Footer>
          ...
          <Carousel.Item interval={3500}>
            <Card bg={"dark"} style={{ maxWidth: "50rem" }}>
              ...
              <Card.Footer>
                ...
                <Button
                  variant="primary"
                  href="https://github.com/Ryankolsen/Jupyter_Notebook_Stack_Survey_2020"
                >
                  See the code
                </Button>
              </Card.Footer>
          ...
          <Carousel.Item interval={3500}>
            <Card bg={"dark"} style={{ maxWidth: "50rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text className="projectCardText">
                  2D dungeon game created on Unity using C# Scripts on Visual
                  Studio<br></br> <br></br>
              ...
              <Card.Footer>
                <Button
                  className="twoButtons"
                  variant="primary"
                  href="https://github.com/Ryankolsen/UnityDungeonFighter/blob/main/DungeonFighter_Data.zip"
                >
                  Download Game
                </Button>
                <Button
                  variant="primary"
                  href="https://github.com/Ryankolsen/UnityDungeonFighter"
                >
                  See the code
                </Button>
              </Card.Footer>
      ...
      >
        <Button size="lg" as={Link} to="/ReactPage">
          Click here to see React stuff
        </Button>
      </Container>
      <Container
        className="pb-5"
